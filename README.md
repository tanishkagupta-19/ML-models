...
<head>
  ...
  <title>Machine Learning Models — Tanishka Gupta</title>
  <style>
    :root{
    ...
    <section id="run">
      ...
      <ol>
        <li>
          ...
          <pre><code>git clone https://github.com/tanishkahupta-19/ML-models.git
cd ml-models-collection</code></pre>
        </li>
        <li>
        ...
        <li>
          ...
          <pre><code>python HousePricePrediction_app.py</code></pre>
        </li>
      </ol>
    ...
    <section id="author">
      ...
      <p>
        ...
        &nbsp;•&nbsp;
        <a href="https://github.com/tanishkahupta-19" target="_blank" rel="noopener">GitHub</a>
      </p>
    </section>
